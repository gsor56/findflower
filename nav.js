        ...
        header.innerHTML =
            '<div class="max-w-7xl mx-auto px-4 sm:px-8 h-16 flex items-center justify-between gap-2">' +
                ...
                '<div class="flex items-center gap-2 sm:gap-3 shrink-0">' +
                    ...
                    '<a id="ffNotifyBell" href="/notifications" aria-label="Notifications" class="relative flex items-center justify-center rounded-full text-[#1a3622]" style="width:40px;height:40px">' +
                        ...
                        '<span id="ffNotifyBadge" class="hidden absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 items-center justify-center bg-[#1a3622] text-white text-[10px] rounded-full"></span>' +
                    '</a>' +
